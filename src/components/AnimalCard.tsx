  ...
  return (
    <Link  href={href} className="flex flex-col ">
        ...
        <div className="flex justify-between flex-col gap-2 lg:flex-row text-[14px] sm:text-base">
            ...
            <span className="flex gap-2">Płeć: {sex} <Image src={`${sex == 'Samiec' ? "/icons/sexBlue.svg" : "/icons/sexPink.svg"}`} width={20} height={20} alt="Płeć"/></span>
        </div>

        <Button iconMobile={true} additionalStyles="mt-3 sm:mt-6 text-[12px] px-2! md:px-6 lg:text-base" text="ZOBACZ WIĘCEJ" bgColor="red"  icon="/icons/bone.svg"/>
    </Link>
  );
}
